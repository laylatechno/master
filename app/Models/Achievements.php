...
class Achievements extends Model
{
    ...
    {
        return $this->belongsTo(DevelopmentCategories::class, 'development_category_id');
    }
    ...
    {
        return $this->belongsToMany(Products::class, 'achievement_products', 'achievement_id', 'product_id');
    }
