                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="form-group">
                                            <strong>Nama:</strong>
                                            <input type="text" name="name" placeholder="Nama" class="form-control" value="{{ $data_user->name }}">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="form-group">
                                            <strong>Email:</strong>
                                            <input type="email" name="email" placeholder="Email" class="form-control" value="{{ $data_user->email }}">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="form-group">
                                            <strong>Role:</strong>
                                            <select name="roles[]" class="select2 form-control" multiple="multiple" style="height: 36px; width: 100%">
